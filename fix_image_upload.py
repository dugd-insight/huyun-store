...
def main():
    ...
    # Upload fixed HomeClient.tsx
    print("Uploading HomeClient.tsx fix...")
    ...
    if "Compiled successfully" in out and "Failed to type check" not in out:
        print("\n[OK] Build succeeded!")
    else:
        print("\n[WARN] Build may have issues")
    ...
    if build_id:
        ...
        print("\n[WARN] BUILD_ID is empty - build may have failed")
